/*!
 * @license :fortjs - V1.10.0 - 07/12/2019
...
var parseAndMatchRoute = function (url, httpMethod) {
    ...
    var route = RouteHandler.findControllerFromPath(firstPart);
    if (route == null) {
...
var compareExpectedAndRemoveUnnecessary = function (expected, actual) {
    ...
    for (var prop in expected) {
        var type = getDataType(expected[prop]);
        var value = void 0;
        switch (type) {
...
var request_handler_RequestHandler = /** @class */ (function (_super) {
    ...
    RequestHandler.prototype.checkExpectedQuery_ = function () {
        var expectedQuery = RouteHandler.getExpectedQuery(this.routeMatchInfo_.controllerName, this.routeMatchInfo_.workerInfo.workerName);
    ...
    RequestHandler.prototype.checkExpectedBody_ = function () {
        var expectedBody = RouteHandler.getExpectedBody(this.routeMatchInfo_.controllerName, this.routeMatchInfo_.workerInfo.workerName);
