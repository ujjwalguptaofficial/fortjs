/*!
 * @license :fortjs - V1.5.5 - 17/04/2019
...
var PostHandler = /** @class */ (function (_super) {
    ...
    PostHandler.prototype.parsePostData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var postData, contentType, result, ex_1, bodyBuffer, ex_2, bodyDataAsString;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(contentType === _enums__WEBPACK_IMPORTED_MODULE_3__["MIME_TYPE"].FormMultiPart)) return [3 /*break*/, 5];
                        result = void 0;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 9:
                        ...
                        switch (contentType) {
                            case _enums__WEBPACK_IMPORTED_MODULE_3__["MIME_TYPE"].Json:
                                try {
                                    ...
                                    return [2 /*return*/, Promise.reject("Post data is invalid")];
                                }
                                break;
                        ...
                        _a.label = 10;
                    case 10: return [2 /*return*/, postData];
                }
            });
        });
    };
