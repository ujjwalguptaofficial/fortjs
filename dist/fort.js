/*!
 * @license :fortjs - V1.8.0 - 05/10/2019
...
var injector_handler_InjectorHandler = /** @class */ (function () {
    ...
    InjectorHandler.addWorkerValue = function (className, methodName, paramIndex, paramValue, shouldFindIndex) {
        ...
        if (savedValue == null) {
            ...
            var savedMethod = savedValue.methods[methodName];
            if (savedMethod == null) {
...
var request_handler_RequestHandler = /** @class */ (function (_super) {
    ...
    RequestHandler.prototype.executeWallIncoming_ = function () {
        ...
        return Promise.all(Global.walls.map(function (wall) {
            var constructorArgsValues = injector_handler_InjectorHandler.getConstructorValues(wall.name);
            ...
            var methodArgsValues = injector_handler_InjectorHandler.getMethodValues(wall.name, 'onIncoming');
    ...
    RequestHandler.prototype.executeShieldsProtection_ = function () {
        ...
        return Promise.all(this.routeMatchInfo_.shields.map(function (shield) {
            var constructorArgsValues = injector_handler_InjectorHandler.getConstructorValues(shield.name);
            ...
            var methodArgsValues = injector_handler_InjectorHandler.getMethodValues(shield.name, 'protect');
    ...
    RequestHandler.prototype.executeGuardsCheck_ = function (guards) {
        ...
        return Promise.all(guards.map(function (guard) {
            var constructorArgsValues = injector_handler_InjectorHandler.getConstructorValues(guard.name);
            ...
            var methodArgsValues = injector_handler_InjectorHandler.getMethodValues(guard.name, 'check');
...
var initController = function (controllerInstance, data) {
    ...
    controllerInstance.file = new file_manager_FileManager();
