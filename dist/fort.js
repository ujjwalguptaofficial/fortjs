/*!
 * @license :fortjs - V1.7.0 - 22/07/2019
...
var fort_Fort = /** @class */ (function () {
    ...
    Fort.prototype.saveAppOption_ = function (option) {
        ...
        if (Object(external_util_["isArray"])(Global.folders) === false) {
...
var request_handler_helper_RequestHandlerHelper = /** @class */ (function () {
    ...
    RequestHandlerHelper.prototype.runWallOutgoing = function () {
        ...
        reverseLoop(this.wallInstances, function (value) {
            var methodArgsValues = InjectorHandler.getMethodValues(value.constructor.name, 'onOutgoing');
...
var external_etag_ = __webpack_require__(10);

// EXTERNAL MODULE: external "fresh"
var external_fresh_ = __webpack_require__(11);
...
var external_content_type_ = __webpack_require__(12);

// EXTERNAL MODULE: external "querystring"
var external_querystring_ = __webpack_require__(13);

// EXTERNAL MODULE: external "multiparty"
var external_multiparty_ = __webpack_require__(14);
...
var request_handler_RequestHandler = /** @class */ (function (_super) {
    ...
    RequestHandler.prototype.executeWallIncoming_ = function () {
        ...
        return Promise.all(Global.walls.map(function (wall) {
            var constructorArgsValues = InjectorHandler.getConstructorValues(wall.name);
            ...
            var methodArgsValues = InjectorHandler.getMethodValues(wall.name, 'onIncoming');
            return wallObj.onIncoming.apply(wallObj, methodArgsValues);
        }));
    };
    RequestHandler.prototype.runController_ = function () {
        var _a;
        var constructorValues = InjectorHandler.getConstructorValues(this.routeMatchInfo_.controller.name);
        ...
        var methodArgsValues = InjectorHandler.getMethodValues(this.routeMatchInfo_.controller.name, this.routeMatchInfo_.workerInfo.workerName);
    ...
    RequestHandler.prototype.executeShieldsProtection_ = function () {
        ...
        return Promise.all(this.routeMatchInfo_.shields.map(function (shield) {
            var constructorArgsValues = InjectorHandler.getConstructorValues(shield.name);
            ...
            var methodArgsValues = InjectorHandler.getMethodValues(shield.name, 'protect');
    ...
    RequestHandler.prototype.executeGuardsCheck_ = function (guards) {
        ...
        return Promise.all(guards.map(function (guard) {
            var constructorArgsValues = InjectorHandler.getConstructorValues(guard.name);
            ...
            var methodArgsValues = InjectorHandler.getMethodValues(guard.name, 'check');
            ...
            return request_handler_generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1:
                        if (!(Global.shouldParsePost === true)) return [3 /*break*/, 3];
                        _a = this;
