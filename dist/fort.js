/*!
 * @license :fortjs - V1.5.9 - 17/06/2019
...
var Route = function (format) {
    return (function (target, methodName, descriptor) {
        ...
        _handlers__WEBPACK_IMPORTED_MODULE_0__["RouteHandler"].addWorkerRoute(format, className, methodName);
    });
};
...
var PostHandler = /** @class */ (function (_super) {
    ...
    PostHandler.prototype.parsePostData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var postData, contentType, result, bodyBuffer, bodyDataAsString;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
var RouteHandler = /** @class */ (function () {
    ...
    RouteHandler.addControllerRoute = function (value) {
    ...
    RouteHandler.addWorkerRoute = function (routePattern, className, actionName) {
        var router = routerCollection.find(function (x) { return x.controllerName === className; });
        if (router == null) {
            routerCollection.push({
                workers: [{
...
var addRoute = function (controllerRoute, workerInfos) {
    var className = controllerRoute.controller.name;
    _handlers__WEBPACK_IMPORTED_MODULE_0__["RouteHandler"].addControllerRoute(controllerRoute);
    workerInfos.forEach(function (route) {
        _handlers__WEBPACK_IMPORTED_MODULE_0__["RouteHandler"].addWorker(route, className);
    });
};
...
/*!******************************!*\
  !*** ./src/helpers/index.ts ***!
  \******************************/
/*! exports provided: jsonResult, textResult, htmlResult, renderView, downloadResult, fileResult, redirectResult, viewResult, getViewFromFile, promise, LogHelper, XmlHelper, getMimeTypeFromExtension, parseAndMatchRoute, parseCookie, addRoute */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _add_route__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./add_route */ "./src/helpers/add_route.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "addRoute", function() { return _add_route__WEBPACK_IMPORTED_MODULE_15__["addRoute"]; });
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: Controller, Shield, SessionProvider, Guard, ViewEngine, Wall, XmlParser, Worker, Shields, Guards, Route, DefaultWorker, MIME_TYPE, HTTP_METHOD, HTTP_STATUS_CODE, ETag_Type, ERROR_TYPE, jsonResult, textResult, htmlResult, renderView, downloadResult, fileResult, redirectResult, viewResult, getViewFromFile, promise, LogHelper, XmlHelper, getMimeTypeFromExtension, parseAndMatchRoute, parseCookie, addRoute, ErrorHandler, HttpCookie, Fort, Router, CookieManager, FileManager, HttpFile, MustacheViewEngine, MemorySessionProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "addRoute", function() { return _helpers__WEBPACK_IMPORTED_MODULE_3__["addRoute"]; });
...
var Fort = /** @class */ (function () {
    ...
    Fort.prototype.create = function (option) {
        ...
        this.routes.forEach(function (route) {
            ...
            _handlers__WEBPACK_IMPORTED_MODULE_0__["RouteHandler"].addControllerRoute(route);
        });
