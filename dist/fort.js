/*!
 * @license :fortjs - V1.15.1 - 15/07/2020
...
function parseAndMatchRoute(url, httpMethod) {
    ...
    var route = route_handler_RouteHandler.findControllerFromPath(urlParts);
    return route == null ? checkRouteInWorker(route_handler_RouteHandler.defaultRoute, httpMethod, urlParts) :
...
var error_handler_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }
...
var error_handler_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var error_handler_ErrorHandler = /** @class */ (function () {
    ...
    ErrorHandler.prototype.onServerError = function (ex) {
        return error_handler_awaiter(this, void 0, void 0, function () {
            var errMessage;
            return error_handler_generator(this, function (_a) {
                ...
                return [2 /*return*/, htmlResult(errMessage, HTTP_STATUS_CODE.InternalServerError)];
            });
        });
    };
    ErrorHandler.prototype.onBadRequest = function (ex) {
        return error_handler_awaiter(this, void 0, void 0, function () {
            ...
            return error_handler_generator(this, function (_a) {
                ...
                return [2 /*return*/, htmlResult(errMessage, HTTP_STATUS_CODE.BadRequest)];
            });
        });
    };
    ErrorHandler.prototype.onForbiddenRequest = function () {
        return error_handler_awaiter(this, void 0, void 0, function () {
            return error_handler_generator(this, function (_a) {
                return [2 /*return*/, htmlResult("<h1>Forbidden</h1>", HTTP_STATUS_CODE.Forbidden)];
            });
        });
    };
    ErrorHandler.prototype.onNotAcceptableRequest = function () {
        return error_handler_awaiter(this, void 0, void 0, function () {
            return error_handler_generator(this, function (_a) {
                return [2 /*return*/, htmlResult("<h1>Not Acceptable</h1>", HTTP_STATUS_CODE.NotAcceptable)];
            });
        });
    };
    ErrorHandler.prototype.onMethodNotAllowed = function () {
        return error_handler_awaiter(this, void 0, void 0, function () {
            return error_handler_generator(this, function (_a) {
                return [2 /*return*/, htmlResult("<h1>Method Not allowed.</h1>", HTTP_STATUS_CODE.MethodNotAllowed)];
            });
        });
    };
    ErrorHandler.prototype.onNotFound = function (url) {
        return error_handler_awaiter(this, void 0, void 0, function () {
            return error_handler_generator(this, function (_a) {
                return [2 /*return*/, htmlResult("<h1>The requested resource " + url + " was not found.</h1>", HTTP_STATUS_CODE.NotFound)];
            });
        });
    };
    return ErrorHandler;
...
var request_handler_helper_RequestHandlerHelper = /** @class */ (function () {
        ...
        return request_handler_helper_awaiter(this, void 0, void 0, function () {
            ...
            return request_handler_helper_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ex_6 = _a.sent();
                        response = JsonHelper.stringify(ex_6);
                        return [3 /*break*/, 4];
                    case 4:
    ...
    RequestHandlerHelper.prototype.endResponse_ = function (negotiateMimeType) {
        ...
        var data;
        try {
            data = getResultBasedOnMiMe(negotiateMimeType, this.controllerResult.responseData, function (type) {
        ...
        this.response.writeHead(this.controllerResult.statusCode || HTTP_STATUS_CODE.Ok, (_a = {}, _a[__ContentType] = negotiateMimeType, _a));
...
var session_provider_SessionProvider = /** @class */ (function () {
    ...
    SessionProvider.prototype.createSession = function (sessionId) {
        var now = new Date();
        this.sessionId = sessionId != null ? sessionId : external_uniqid_();
...
var fort_Fort = /** @class */ (function () {
    ...
    Fort.prototype.create = function (option) {
        ...
        this.routes.forEach(function (route) {
            ...
            if (route.path === "/*") {
                route_handler_RouteHandler.defaultRouteControllerName = route.controller.name;
                isDefaultRouteExist = true;
            }
        });
        if (isDefaultRouteExist === false) {
            route_handler_RouteHandler.defaultRouteControllerName = GenericController.name;
        ...
        return promise(function (res, rej) {
            _this.httpServer = external_http_["createServer"](_this.onNewRequest).once("error", function (err) {
...
/* concated harmony reexport ComponentOption */__webpack_require__.d(__webpack_exports__, "ComponentOption", function() { return ComponentOption; });
